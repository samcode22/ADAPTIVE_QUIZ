# Generated by Django 2.2.7 on 2020-01-15 13:27
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('answer_order', models.CharField(blank=True, choices=[('content', 'Content'), ('none', 'None'), ('random', 'Random')], help_text='The order in which multichoice                     answer options are displayed                     to the user', max_length=30, null=True, verbose_name='Answer Order')),
            ],
